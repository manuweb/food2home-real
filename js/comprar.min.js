                ...
                $.ajax({
                    ...
                    success: function(data){
                        ...
                        if (obj.valid==true){
                            ...
                            if (llevabolsa=='si'){
                                tot=carritoSubtotal+precioBolsa; 
                            }
                                  
                               
                                document.all.iframe_tpv.src = servidor+'includes/tpv.php?importe='+tot+'&order='+obj.order+'&idpedido='+obj.idpedido+'&esbizum='+esbizum;
