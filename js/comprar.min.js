...
function ponebotonesmetodo(envio,hay_reparto,hay_cocina){
    var txt='<div><button class="button button-outline button-envio" style="height: auto;font-size: 18px;padding:5px;width: 90%;margin: auto;" onclick="cambiametodoenviobut(this,'+hay_reparto+','+hay_cocina+');" data-metodo="2"><i class="icon material-icons">shopping_bag</i>&nbsp;Recoger</button></div>'+
    '<div><button class="button button-outline button-envio" style="height: auto;font-size: 18px;padding:5px;width: 90%;margin: auto;" onclick="cambiametodoenviobut(this,'+hay_reparto+','+hay_cocina+');" data-metodo="1"><i class="icon material-icons">delivery_dining</i>&nbsp;Domicilio</button></div>';
...
function terminarcompra(){
   ...
   if (fidelizacion=='1'){
    ...
    $.ajax({
        type: "POST",
        url: server,
        data: {envio:envio, hora:hora, dia:dia},
        dataType:"json",
        success: function(data){
            var obj=Object(data);
            if (obj.valid==true){
