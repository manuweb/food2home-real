...
function checkout_3(){
    ...
    */
    ...
    mirasihaypedidosoy(fecha_pedido);
...
function mirasihaypedidosoy(fecha){
    ...
    $.ajax({
        url: server,
        data:{horario:disponiblereparto, horariococina: disponiblecocina,fecha:fecha_pedido},
        method: "post",
        dataType:"json",
        success: function(data){ 
            var obj=Object(data);
...
//console.log('hora_envio:'+hora_envio);
    ...
    var txt_pre='<span style="font-size:16px;">'+txt_envio+'<br>Hora:<b>'+hora_envio+'</b>'
