...
function ponelashoras(hay_reparto,hay_cocina){
    ...
    if (tipo_seleccion_horas==2){
        entrega='<p class="grid grid-cols-2 grid-gap">'+opcionescocina+'</p>';
    }
    ...
    if ((!hay_reparto)&&(!hay_cocina)){
        ...
        if ((hay_reparto)&&(!hay_cocina)){
            ...
            if (tipo_seleccion_horas==0){
                entrega='<input id="hora-reparto" type="hiden" value="'+disponiblereparto[0]+'"><p>Hora: <b>'+disponiblereparto[0]+'</b></p>';
            }
        }
...
function cambiametodoenvio(){
    ...
    if (envio=='1') {
        ...
        if (tipo_seleccion_horas==2){
            for (x=0;x<disponiblereparto.length;x++){
                opciones+='<button class="button-horario button button-large button-raised" data-hora="'+disponiblereparto[x]+'">'+disponiblereparto[x]+txtCortesia(disponiblecocina[x])+'</button>';
            }
        }
    ...
    if (tipo_seleccion_horas==2){
        entrega='<p class="grid grid-cols-2 grid-gap">'+opciones+'</p>';
    }
    $('#horas-entrega').html(entrega);
