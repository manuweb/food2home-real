...
function renderizarCarrito() {
    ...
    for (var x=0;x<carrito.length;x++) {
        ...
        if (carrito[x]['menu']==5){
            sumar='<div class="text-align-center"  style="width:10%;"></div>';
        }
        ...
        if (carrito[x]['menu']==5){
            restar='<div class="text-align-center"  style="width:10%;"></div>';
        }
...
function addCarrito (e, cantidad=1,comentario) {
    ...
    var esMenu=e.getAttribute('data-esmenu');
    var nombreT='';
    var emailT='';
    if (esMenu==5){
        nombreT=e.getAttribute('data-nombre-tarjeta');
        emailT=e.getAttribute('data-email-tarjeta');
    }
    //console.log(mod);
    ...
    for (var x=0;x<carrito.length;x++) {
        ...
        if ((carrito[x]['id']==id)&&(carrito[x]['menu']!=1)){
            if (comentario!='') {
    ...
    if (existe=='no'){
        carrito.push({id:id,nombre:nombre,precio:precio, precio_sin:precio_sin,cantidad:cantidad,iva:iva,img:img,menu:esMenu,elmentMenu:0,comentario:comentario,modificadores:nuevoA,categoria:cat,nombreT:nombreT,emailT:emailT});
    }    
