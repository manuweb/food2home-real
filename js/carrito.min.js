...
function addCarrito (e, cantidad=1,comentario) {
    ...
    if (existe=='no'){
        carrito.push({id:id,nombre:nombre,precio:precio, precio_sin:precio_sin,cantidad:cantidad,iva:iva,img:img,menu:0,elmentMenu:0,comentario:comentario,modificadores:nuevoA});
    }    
