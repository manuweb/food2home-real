...
function addCarritoMenu(e){
    ...
    carrito.push({id:$('#add-to-cart').attr('data-id'),nombre:nombre ,precio:precio,  precio_sin:precio_sin, cantidad:1,iva:$('#add-to-cart').attr('data-iva'),img:img,mod:null, comentario:comentario,menu:1,elmentosMenu:elmentosMenu});
