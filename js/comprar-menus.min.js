    ...
    $('.elem-menu-opc').each(function(){
        if ($(this).attr('type')=='text'){
            if (parseInt($(this).val())>0){
                ...
                elmentosMenu.push({id:datos[2],nombre:datos[3],precio:datos[7] ,cantidad:parseInt($(this).val()) ,iva:datos[9] ,img:datos[8] ,mod:null,idMenu:datos[10]});
            ...
            if ($(this).prop('checked')){
                ...
                var datos=contenido.split("#"); elmentosMenu.push({id:datos[2],nombre:datos[3],precio:datos[7] ,cantidad:1 ,iva:datos[9] ,img:datos[8] ,mod:null,idMenu:datos[10]});
