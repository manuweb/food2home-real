...
function muestraproductoinicio(id) {
    ...
    var server=servidor+'includes/buscaProdCat.php';
    $.ajax({
        type: "POST",
        url: server,
        data: {tipo:'producto',id:id,tienda:tienda},
        dataType:"json",
        success: function(data){
            ...
            if (obj.valid==true){
                ...
                muestraelproducto(id,nombre,gru_id,gru_nombre,cat_id,cat_nombre,modifierCategories,'0');
            }
...
function muestracategoriainicio(id) {
    var tienda=0;
    if (localStorage.getItem("tiendaSeleccionada") != null) {
        tienda=desencripta(localStorage.getItem("tiendaSeleccionada"));
    }
    ...
    $.ajax({
        type: "POST",
        url: server,
        data: {tipo:'categoria',id:id,tienda:tienda},
        dataType:"json",
        success: function(data){
            var obj=Object(data);
            console.log(obj);
            if (obj.valid==true){
               ...
               muestraproductos(gru_id,gru_nombre,id,nombre);
